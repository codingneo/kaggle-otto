...
best_params = []
for num_iter in range(800, 2000, 100):
	for depth in range(9, 27, 3):
		...
		if (logloss < best_logloss):
			...
			fs = './submission/graphlab-xgbt/pickle_xgbt-' + str(num_iter) + '_' + str(depth) + '-' + str(best_logloss)
			with open(fs, 'w') as f:
